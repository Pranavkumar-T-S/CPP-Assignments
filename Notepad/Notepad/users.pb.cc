...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_users_2eproto[1];
...
const uint32_t TableStruct_users_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::users::User, _impl_.password_),
  ...
  PROTOBUF_FIELD_OFFSET(::users::User, _impl_.mobile_),
  ~0u,
  ~0u,
  0,
  1,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 12, -1, sizeof(::users::User)},
  { 18, -1, -1, sizeof(::users::Users)},
};
...
const char descriptor_table_protodef_users_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013users.proto\022\005users\"\250\001\n\004User\022\020\n\010usernam"
  "e\030\001 \001(\t\022\020\n\010password\030\002 \001(\t\022\021\n\004name\030\003 \001(\tH"
  "\000\210\001\001\022\022\n\005email\030\004 \001(\tH\001\210\001\001\022\025\n\010location\030\005 \001"
  "(\tH\002\210\001\001\022\023\n\006mobile\030\006 \001(\tH\003\210\001\001B\007\n\005_nameB\010\n"
  "\006_emailB\013\n\t_locationB\t\n\007_mobile\"#\n\005Users"
  "\022\032\n\005users\030\001 \003(\0132\013.users.User*\036\n\006Gender\022\010"
...
const ::_pbi::DescriptorTable descriptor_table_users_2eproto = {
    false, false, 268, descriptor_table_protodef_users_2eproto,
    "users.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "users.User.username"));
        } else
          goto handle_unusual;
        continue;
      // string password = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "users.User.password"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "users.User.mobile"));
        } else
          goto handle_unusual;
        continue;
      default:
